				...
				if (a != null) {
					...
					while (flag) {
						...
						case 4:
							...
							break;
						case 5:
							Map<Float, String> transactions = service.printTransactions(a);
							for (Map.Entry<Float,String> entry : transactions.entrySet()) {
